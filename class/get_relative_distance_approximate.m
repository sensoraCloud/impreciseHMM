...
for c=1:cls
    ...
    for m=1:mdl
        ...
        if isempty(precise_models{c,m})==0
            ...
            elseif typeGenerationMultiplePoints==2
                
            %transition
                
                N=size(model_train{1},1);
                ...
                for a=1:sizAs
                    ...
                    if C==1
                        ...
                        [ hsdImp ] = distance_HSD_approximate(PiUniform,transition_matrices{1,a},model_train{5},multi_features,minimum_value,[],model_train{3},model_train{4},q,alpha,L );
                        
                    else
                        
                        [ hsdImp ] = distance_HSD_approximate(PiUniform,transition_matrices{1,a},model_train{5},multi_features,minimum_value,[],model_train{3},alpha );
            ...
            if (typeGenerationMultiplePoints==1 || typeGenerationMultiplePoints==2)
