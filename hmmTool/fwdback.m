...
%compila la prima colonna alpha_1(t) = pi_i * b_1(o_1)
t = 1;
alpha(:,1) = init_state_distrib(:) .* obslik(:,t);

%normalizza a 1 la prima colonna
if scaled
 %[alpha(:,t), scale(t)] = normaliseC(alpha(:,t));
 [alpha(:,t), scale(t)] = normalise(alpha(:,t));
end

%controlla che la somma della colonna sia approsimativamente uguale a 1

%assertPredicate(approxeq(sum(alpha(:,t)),1))
